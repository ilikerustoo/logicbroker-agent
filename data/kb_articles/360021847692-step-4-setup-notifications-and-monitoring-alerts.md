---
title: "Step 4: Setup Notifications and Monitoring Alerts"
url: "https://support.logicbroker.com/kb/logicbroker/360021847692-step-4-setup-notifications-and-monitoring-alerts"
category: "Retailer Onboarding"
---

March 12, 2026

# Step 4: Setup Notifications and Monitoring Alerts
...
Notifications and Monitoring alerts are emails that are triggered to your configured address to proactively monitor your system. Reports can be configured, alerts sent when errors occur, or when encountering connectivity issues. Navigate to **Settings** > **Notification Configuration** to setup your subscriptions. This will help in monitoring your suppliers activity to hold them accountable and verify all integrations within your own system.
...
---|---|---  
[**New order**](https://support.logicbroker.com/hubfs/logicbroker_media/\(STAGE\)%20New%20order%20summary.htm?hsLang=en) |  Provides a count of all new orders received in the past hour. Will include a link to view the new orders in the Portal.  Provides an alert to the first sales order from a retailer and the first purchase order between partners sent to both the retailer and supplier.  |   
...
[**Monthly order count**](https://support.logicbroker.com/hubfs/logicbroker_media/Monthly%20Order%20Report.htm?hsLang=en) |  Will send once a month and include the total number of orders received for that month. Must setup the **Monthly Order Report** to under Monitoring to receive email notification. |   
...
[**Unknown EDI documents**](https://support.logicbroker.com/hubfs/logicbroker_media/STAGE%20Unable%20to%20determine%20senderreceiver%20for%20EDI%20846%20%23100001857.htm?hsLang=en) |  Will trigger when an EDI document is received for your account an your partner's identifiers do not match any partners you are connected to. |  ✅  
...
[**Overdue documents**](https://support.logicbroker.com/hubfs/logicbroker_media/Orders%20Overdue.htm?hsLang=en) |  Configured under the Monitoring page. Will provide a list of documents that are still open. Similar to the aging report however will provide a list of open orders, with a maximum of 50 in each report. |  ✅  
...
[**Order 72 Hours Overdue to Ship**](https://support.logicbroker.com/hubfs/logicbroker_media/Orders%20Overdue.htm?hsLang=en) |  Lists all orders that have not shipped within 72 hours. A maximum of 50 orders will be listed. |   
