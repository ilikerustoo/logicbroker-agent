...
url: "https://support.logicbroker.com/kb/logicbroker/360021847452-introduction-what-is-logicbroker"
...
As a retailer, you will be using Logicbroker to send orders to all of your suppliers. Our goal is to help you integrate all your fulfillment channels, whether its a supplier using EDI, 3PL, or internal warehouse, we have a full library of options to get you connected quickly. All documents and information will always be formatted in one canonical format allowing you to process data from hundreds of different channels using one connection.

##### Document Types

**Order**

The order will contain all information required to fulfill your orders; this includes addresses, Item identifiers, and quantities. Each order starts a new flow and all related documents submitted thereafter will be linked, updating the order status until the order is complete (fulfilled and invoiced).
...
This document is sent to your partner when a return is physically received on a order previously fulfilled. It will typically provide data on which products were received and why it was returned. Then, a credit can be issued. 
...
Using the portal you can manually manage all orders, acknowledge, ship, invoice and update inventory. A user account will be provisioned and will be available for all integration options.
...
All documents in the Logicbroker system are processed based on status. Workflows are configured to send documents to your partners or integrated systems. Statuses on your documents will indicate what action you need to take next to process your documents. 
...
Logicbroker can customize your workflow to connect to integrated systems, trigger webhooks, or send documents to custom endpoints/locations. We can integrate with any customized business workflow. [Contact us](mailto:sales@logicbroker.com) for more information.
