...
- `invoice` (body, string, required): The new invoice
...
### `GET /api/v3/Invoices/BrandedInvoice`

Get branded invoice for multiple invoices
...
### `POST /api/v3/Invoices/CreateImport`
...
### `POST /api/v3/Invoices/CustomXML`

Create invoice(s) based on custom XML
...
### `GET /api/v3/Invoices/LogicbrokerKeys/Ready`

Get invoice keys that are ready for processing
...
### `GET /api/v3/Invoices/Ready`

Get invoices that are ready for processing
...
### `POST /api/v3/Invoices/Remittance`

Create an invoice from retailer to supplier
...
- `201`: Remittance invoice created.
- `400`: Invoice data was invalid.
---

### `PUT /api/v3/Invoices/Status`
...
### `GET /api/v3/Invoices/{LogicbrokerKey}`

Returns the invoice with the specified key

Request rate limited to 10 requests per second with bursts up to 100 requests.

**Parameters:**

- `LogicbrokerKey` (path, string, required): The logicbroker key to search for.
...
### `GET /api/v3/Invoices/{LogicbrokerKey}/BrandedInvoice`

Get branded invoice for one invoice
...
### `GET /api/v3/Invoices/{LogicbrokerKey}/EDI`
...
### `GET /api/v3/Invoices/{LogicbrokerKey}/Events`
...
### `GET /api/v3/Invoices/{LogicbrokerKey}/Status`

Return the current status code of an invoice

Request rate limited to 10 requests per second with bursts up to 100 requests.

**Parameters:**

- `LogicbrokerKey` (path, string, required): The logicbroker key of the invoice to look up.
...
### `PUT /api/v3/Invoices/{LogicbrokerKey}/Status/{Status}`

Updates an invoice to the specified status

Request rate limited to 10 requests per second with bursts up to 100 requests.

**Parameters:**

- `LogicbrokerKey` (path, string, required): The logicbroker key of the invoice to update.
